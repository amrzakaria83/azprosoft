...
{
    protected $viewPath = 'subadmin.message';
    private $route = 'subadmin.messages';
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $data = $this->objectModel::where('sender_type', 0)->where('sender_id', auth('subadmin')->user()->id);
    ...
    {
        $data = $this->objectModel::get();
        $codemp = Auth::guard('subadmin')->user()->id;
        if ($request->ajax()) {
    ...
    public function store(Request $request)
    {
        ...
        if ($validate->fails()) {
            ...
            $row = Message::create([
                ...
                'sender_type'=> 0,
                'sender_id'=> Auth::guard('subadmin')->user()->id,
            ]);
    ...
    public function update(Request $request)
    {
        ...
        $data->update([
            'name' => auth('subadmin')->user()->name_ar,
            'email' => auth('subadmin')->user()->email,
            'phone' => auth('subadmin')->user()->phone,
            'description' => $request->description,
            'status' => 'unread',
            'receiver_type' => 'user',
            'receiver_id' => $request->receiver_id,
            'sender_type'=>'user',
            'sender_id'=> auth('subadmin')->user()->id,
        ]);
