...
class Product_impsController extends Controller
{
    ...
    public function import(Request $request)
    {
        ...
        try {
            ...
            return redirect('/subadmin')->with('success', 'Excel data imported successfully!');
    ...
    public function create()
    {
        ...
        return view('subadmin.product_imp.create');
    }
        public function createimport()
    {
        
        return view('subadmin.product_imp.import');
    }
    // public function create()
    // {
    //     $data = Product::first('updated_at');
    //     return view('subadmin.product_imp.create', compact('data'));
    // }
    ...
    //     return view('subadmin.pur_drug_request.create', compact('sites'));
    // }   
