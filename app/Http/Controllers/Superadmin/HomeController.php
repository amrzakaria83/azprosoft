...
class HomeController extends Controller
{
    public function index() {
        ...
        return view('superadmin/dashboard', compact('month_result','count_user'));
    ...
    public function out_attendance(Request $request)
    {
        ...
        if ($data !== null) {
            ...
            if ($data->emp_code_in == Auth::guard('superadmin')->user()->emp_code) {

                Auth::guard('superadmin')->logout();
                session()->forget('insite');
                return redirect('superadmin/login')->with('message', 'تم تسجيل الانصراف بنجاح')->with('status', 'success');
            }
