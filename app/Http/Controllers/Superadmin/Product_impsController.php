...
class Product_impsController extends Controller
{
    ...
    public function import(Request $request)
    {
        ...
        try {
            ...
            return redirect('/superadmin')->with('success', 'Excel data imported successfully!');
    ...
    public function create()
    {
        ...
        return view('superadmin.product_imp.create');
    }
        public function createimport()
    {
        
        return view('superadmin.product_imp.import');
    }
    // public function create()
    // {
    //     $data = Product::first('updated_at');
    //     return view('superadmin.product_imp.create', compact('data'));
    // }
    ...
    //     return view('superadmin.pur_drug_request.create', compact('sites'));
    // }   
