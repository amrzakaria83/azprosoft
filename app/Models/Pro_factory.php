...
class Pro_factory extends SqlServerModel
{
    use HasFactory;
    /**
     ...
     * @var string
     */
    protected $table = 'factory';  // Replace with your actual table name
     ...
     * @var string
     */
    protected $primaryKey = 'factory_id';  // Replace with your primary key if different
