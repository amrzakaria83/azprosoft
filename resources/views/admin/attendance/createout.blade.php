    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
                <h1 class="text-center text-danger fw-bolder">{{trans('lang.out_attendance')}}</h1>
                <!--begin::Form-->
                <form action="{{route($route. '.out_attendance')}}" method="POST" enctype="multipart/form-data" id="kt_account_profile_details_form" class="form">
                    @csrf
                    ...
                    <a href="" id="out_attendance" class="btn btn-lg  btn-danger btn-active-success  align-middle container ">
                                                            <span>{{trans('lang.out_attendance')}}</span>
                                                            
                                                        </a>
                        <!-- <button type="submit" class="btn btn-danger" id="kt_account_profile_details_submit">{{trans('lang.out_attendance')}}</button> -->
                    </div>
                    <!--end::Actions-->
...
<script>
$('#out_attendance').click(function(e) {
            e.preventDefault();
