...
@section('content')
    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card no-border">
                ...
                <!--end::Card header-->
                <!--begin::Card body-->
                <form action="{{route('admin.attendances.store_emp_index_plan')}}" method="POST" enctype="multipart/form-data" id="kt_account_profile_details_form" class="form">
                    @csrf
                    <!--begin::Card body-->
...
<script src="{{asset('dash/assets/plugins/custom/datatables/buttons.print.min.js')}}"></script>
    <script>
        $('.name_ar').select2({
                ...
                ajax: {
                    type: "GET",
                    url: "{{ url('admin/order_ph_requests/getempdelselect') }}",
                    dataType: 'json',
                    delay: 250,
...
<script>
                ...
                $('.plan_att_mission_id').select2({
                        ...
                        ajax: {
                            type: "GET",
                            url: "{{ url('admin/attendances/getplan_att_emp_vacation') }}",
                            dataType: 'json',
                            delay: 250,
                            processResults: function (data) {
                                mission = data;
