            ...
            <div class="card no-border">
                ...
                <div class="card-body py-4">
                    <div class="row mb-6">
                        ...
                        <div class="col-sm-4">
                            <label class="required fw-semibold fs-6 mb-2 text-center">{{trans('lang.employee')}}</label>
                            
                            <div class="position-relative d-flex align-items-center">
                                <select class="form-select "  placeholder="{{trans('lang.employee')}}" aria-label="Select example" id="emp_code" name="emp_code" data-control="select2">
                                        <option value="" selected disabled>{{trans('lang.employee')}}</option>
                    ...
                    <table class="table align-middle table-rounded table-striped table-row-dashed fs-6" id="kt_datatable_table">
                        ...
                        <thead class="bg-light-dark pe-3">
                            ...
                            <tr class="text-start text-dark fw-bold fs-4 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px text-start">{{trans('lang.end_to')}}</th>
    ...
    $(function () {
        ...
        var table = $('#kt_datatable_table').DataTable({
            ...
            columns: [
                ...
                {data: 'attendance_in_at', name: 'attendance_in_at'},
                {data: 'attendance_out_at', name: 'attendance_out_at'},
        ...
        $('#kt_datepicker_1,#kt_datepicker_2,#emp_code').change(function() {
            table.draw();
        });
        ...
        Swal.fire({title: 'هل انت متأكد ؟',
            ...
            cancelButtonText: 'لا'}).then(function (isConfirm) {if (isConfirm.value) {$.ajax({url: "{{route($route.'.delete')}}",
