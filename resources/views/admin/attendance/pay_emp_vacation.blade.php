                ...
                <div class="card-body py-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7 text-center">
                            ...
                            <label class="required fw-semibold fs-6 mb-2">ادخل اسم الموظف او كوده</label>
                    ...
                    <table class="table align-middle table-rounded table-striped table-row-dashed fs-6" id="kt_datatable_table">
                        ...
                        <thead class="bg-light-dark pe-3">
                            ...
                            <tr class="text-start text-dark fw-bold fs-4 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px text-start">اليوم</th>
                                <th class="min-w-125px text-start">الحضور الفعلى</th>
                                <th class="min-w-125px text-start">الاجازات</th>
                                <th class="min-w-125px text-start">مكان الحضور</th>
                                <th class="min-w-125px text-start">موظف التوقيع</th>
...
<script>
    $("#kt_datepicker_1").flatpickr({defaultDate: new Date(new Date().setDate(new Date().getDate() - 30))});
...
<script>
    $('.name_ar').select2({
            ...
            ajax: {
                type: "GET",
                url: "{{ url('admin/attendances/getempdelselect') }}",
                dataType: 'json',
                delay: 250,
...
{{-- <script>
    $(function () {
        ...
        var table = $('#kt_datatable_table').DataTable({
            ...
            ajax: {
                url: "{{ route($route.'.emp_index_all_notready') }}",
                data: function (d) {
                    d.search = $('#search').val()
                }
            },
            columns: [
                ...
                {data: 'attendance_time_in', name: 'attendance_time_in'},
                {data: 'start_id', name: 'start_id'},
                {data: 'emp_code_in', name: 'emp_code_in'},
