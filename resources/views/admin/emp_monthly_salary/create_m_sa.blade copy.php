                    ...
                    <table class="table align-middle table-rounded table-striped table-row-dashed fs-6" id="kt_datatable_table">
                        ...
                        <thead class="bg-light-dark pe-3">
                            ...
                            <tr class="text-center text-dark fw-bold fs-4 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px text-center">{{trans('lang.actualworkedhours')}}</th>
                                <th class="min-w-125px text-center">{{trans('lang.days')}} {{trans('lang.work')}}</th>
                                <th class="min-w-125px text-center">{{trans('lang.days')}} {{trans('lang.absence')}}</th>
                                <th class="min-w-125px text-center">{{trans('lang.out')}} {{trans('lang.work_hours')}}</th>
                                <th class="min-w-125px text-center">{{trans('lang.valuable')}} {{trans('lang.actualworkedhours')}}</th>
                                <th class="min-w-125px text-center">{{trans('lang.late')}} {{trans('lang.attendance_in')}}</th>
                                <th class="min-w-125px text-center">{{trans('lang.attendance_out')}} {{trans('lang.early')}}</th>
                                <th class="min-w-125px text-center">{{trans('lang.penalties')}}</th>
                                <th class="min-w-125px text-center">{{trans('lang.rewards')}}</th>
                        ...
                        <tbody class="text-gray-600 fw-bold text-center">
                            @if(isset($emps))
                                ...
                                <tr>
                                        <td></td>
                                        <td>{{$item['name_ar']}}</td>
                                        <td>{{$item['totalmail']}}</td>
                                        <td>{{$item['typemail']}}</td>
                                        <td>{{round($item['actualWorkedHours'], 2)}}</td>
                                        <td>{{$item['daysWithAttendance']}}</td>
                                        <td>{{$item['daysWithoutAttendance']}}</td>
                                        <td class="text-info">{{$item['hoursOutsidePlan']}}</td>
                                        <td class="text-info">{{$item['valueactualWorkedHours']}}</td>
                                        <td class="text-danger">{{$item['totalLateMinutes']}}</td>
                                        <td class="text-danger">{{$item['totalEarlyMinutes']}}</td>
                                        <td class="text-danger">{{$item['totalpenal']}}</td>
                                        <td class="text-success">{{$item['totalreward']}}</td>
