...
@php
    $route = 'admin.emp_plan_atts';
    $viewPath = 'admin.emp_plan_att';
@endphp
                    ...
                    <table class="table align-middle table-rounded table-striped table-row-dashed fs-6" id="kt_datatable_table">
                        ...
                        <thead class="bg-light-dark pe-3">
                            ...
                            <tr class="text-center text-dark fw-bold fs-4 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px text-center">{{trans('lang.in_attendance')}}</th>
                                <th class="min-w-125px text-center">{{trans('lang.out_attendance')}}</th>
                                <th class="min-w-125px text-center">{{trans('lang.duration')}}</th>
                                <th class="min-w-125px text-center">{{trans('lang.weekly_dayoff')}}</th>
                                <th class="min-w-125px text-center">{{trans('lang.work_location')}}</th>
    ...
    $(function () {
        ...
        var table = $('#kt_datatable_table').DataTable({
            ...
            columns: [
                ...
                {data: 'weekly_dayoff', name: 'weekly_dayoff'},
                {data: 'work_loct_id', name: 'work_loct_id'},
