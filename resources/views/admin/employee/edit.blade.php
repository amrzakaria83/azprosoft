                ...
                <form action="{{route('admin.employees.update')}}" method="POST" enctype="multipart/form-data" id="kt_account_profile_details_form" class="form">
                    ...
                    <div class="card-body border-top p-9">
                        ...
                        <div class="row mb-6">
                            ...
                            <label class="col-sm-5 col-form-label  fw-semibold fs-6" style=" max-width: 7% !important;">الوظيفة </label>
                        ...
                        <div class="col-sm-3 d-flex align-items-center">
                            <select  class="form-select form-select-lg form-select-solid" id="type"  name="type" value="{{$data->type}}" >
                                ...
                                <option value="3"@if($data->type == '3') selected @endif disabled></option>
                            </select>
                        </div><br>
