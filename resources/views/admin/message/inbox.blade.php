    ...
    <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_header_nav'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
            <li class="breadcrumb-item text-muted px-2">
                <a  href="{{route('admin.messages.index')}}" class="text-muted text-hover-primary">الرسائل</a>
            </li>
...
@section('content')
    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        <a href="{{route('admin.messages.inbox')}}" class="btn btn-outline btn-outline-dashed btn-outline-primary btn-active-light-primary">البريد الوارد</a>
        <a href="{{route('admin.messages.index')}}" class="btn btn-outline btn-dashed btn-primary btn-active-light-primary">البريد الصادر</a>
        <a href="{{route('admin.messages.reportcc')}}" class="btn btn-outline btn-dashed btn-primary btn-active-light-primary">المتابعة</a>
