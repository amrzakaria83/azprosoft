...
@section('content')
    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        <a href="{{route('admin.messages.inbox')}}" class="btn btn-outline btn-dashed btn-primary btn-active-light-primary">البريد الوارد</a>
        <a href="{{route('admin.messages.index')}}" class="btn btn-outline btn-dashed btn-primary btn-active-light-primary">البريد الصادر</a>
        <a href="{{route('admin.messages.reportcc')}}" class="btn btn-outline btn-dashed btn-dashed btn-active-light-primary">المتابعة</a>
