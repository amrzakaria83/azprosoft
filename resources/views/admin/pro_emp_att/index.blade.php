                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end dbuttons">
                            {{-- <a href="{{route('admin.pro_emp_atts.create')}}" class="btn btn-sm btn-icon btn-primary btn-active-dark me-3 p-3"> --}}
...
<script>
    $(function () {
        ...
        var table = $('#kt_datatable_table').DataTable({
            ...
            ajax: {
                url: "{{ route('admin.pro_emp_atts.index') }}",
                data: function (d) {
            ...
            columns: [
                ...
                {data: 'date', name: 'date'},
                {data: 'type', name: 'type'},
                {data: 'insert_emp_id', name: 'insert_emp_id'},
