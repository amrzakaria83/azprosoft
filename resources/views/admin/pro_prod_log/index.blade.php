    ...
    <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_header_nav'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
            <li class="breadcrumb-item text-muted px-2">
                <a  href="#" class="text-muted text-hover-primary">{{trans('lang.movement')}} {{trans('lang.products')}}</a>
            </li>
                ...
                <div class="card-header border-0 pt-6">
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kt-db-table-filter="search" id="search" name="search" class="form-control form-control-solid bg-light-dark text-dark w-250px ps-14" placeholder="{{trans('lang.products')}}" />
                        </div>
                    </div>
                    <div class="card-toolbar">
                        <!--begin::Toolbar-->
                        <div class="d-flex justify-content-end dbuttons">
                            <a href="{{route('admin.pro_prod_logs.create')}}" class="btn btn-sm btn-icon btn-primary btn-active-dark me-3 p-3">
...
<script>
    $(function () {
        ...
        var table = $('#kt_datatable_table').DataTable({
            ...
            ajax: {
                url: "{{ route('admin.pro_prod_logs.index') }}",
                data: function (d) {
        ...
        $("#btn_delete").click(function(event){
            ...
            confirmButtonText: 'موافق',cancelButtonText: 'لا'}).then(function (isConfirm) {
                if (isConfirm.value) {
            $.ajax({
                url: "{{route('admin.pro_prod_logs.delete')}}",
                type: 'post',
                dataType: "JSON",
                data: {
                    "id": checkIDs,
