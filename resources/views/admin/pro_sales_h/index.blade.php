                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end dbuttons">
                            <a href="{{route('admin.pro_sales_hs.create')}}" class="btn btn-sm btn-icon btn-primary btn-active-dark me-3 p-3">
...
<script>
    $(function () {
        ...
        var table = $('#kt_datatable_table').DataTable({
            ...
            ajax: {
                url: "{{ route('admin.pro_sales_hs.index') }}",
                data: function (d) {
        ...
        $("#btn_delete").click(function(event){
            ...
            confirmButtonText: 'موافق',cancelButtonText: 'لا'}).then(function (isConfirm) {
                if (isConfirm.value) {
            $.ajax({
                url: "{{route('admin.pro_sales_hs.delete')}}",
                type: 'post',
                dataType: "JSON",
                data: {
                    "id": checkIDs,
