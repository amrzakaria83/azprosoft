    ...
    <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_header_nav'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
            <li class="breadcrumb-item text-muted px-2">
                <a  href="#" class="text-muted text-hover-primary">{{trans('lang.vacation')}}</a>
            </li>
...
@section('content')
    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card no-border">
                @if (App::getLocale() == 'ar')<h1>طلبات الاجازة</h1>@else <h1>Vacation requests</h1>@endif
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end dbuttons">
                            {{-- <a href="{{route('admin.vacationemps.create')}}" class="btn btn-sm btn-icon btn-primary btn-active-dark me-3 p-3">
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="col-sm-12 fv-row">
                                <select  data-placeholder="Select an option" class=" input-text form-control  form-select  mb-3 mb-lg-0 text-center" id="emp_vacation" name="emp_vacation" data-control="select2" >
                                ...
                                <th class="w-10px p-3">
                                    <div class="form-check form-check-sm form-check-custom form-check-solid ">
                                        <input class="form-check-input" type="checkbox" data-kt-check="true" data-kt-check-target="#kt_datatable_table .form-check-input" value="1" />
                                            ...
                                            <th class="min-w-125px text-start text-center">{{trans('lang.vacation_type')}}</th>
                                            <th class="min-w-125px text-start text-center">{{trans('lang.note')}}</th>
                                            <th class="min-w-125px text-start text-center">{{trans('lang.action')}}</th>
                            </tr>
                            <!--end::Table row-->
                        </thead>
                        <!--end::Table head-->
...
<script>
    ...
    $("#kt_datepicker_2").flatpickr({defaultDate: new Date(new Date().setMonth(new Date().getMonth() + 1))});
...
<script>
    $(function () {
        ...
        var table = $('#kt_datatable_table').DataTable({
            ...
            ajax: {
                url: "{{ route('admin.vacationemps.indexall') }}",
                data: function (d) {
                    d.is_active = $('#is_active').val(),
                    d.from_time = $('#kt_datepicker_1').val(),
                    d.to_date = $('#kt_datepicker_2').val(),
                    d.emp_vacation = $('#emp_vacation').val(),
                    d.search = $('#search').val()
                }
            },
            columns: [
                ...
                {data: 'vactionfrom', name: 'vactionfrom'},
                {data: 'vactionto', name: 'vactionto'},
                {data: 'countdays', name: 'countdays'},
                {data: 'vacation_couse', name: 'vacation_couse'},
        ...
        $('#kt_datepicker_1,#kt_datepicker_2,#emp_vacation').change(function() {
            table.draw();
        });
            ...
            if (checkIDs.length > 0) {
                ...
                Swal.fire({
                    ...
                    if (isConfirm.value) {
                        $.ajax(
                        {
                            url: "{{route('admin.vacationemps.delete')}}",
                            type: 'post',
                            dataType: "JSON",
                            data: {
                                "id": checkIDs,
