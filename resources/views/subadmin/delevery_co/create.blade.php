    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
                    ...
                    <div class="card mb-5 mb-xl-10">
                        ...
                        <div id="kt_account_settings_profile_details" class="collapse show">
                            <form action="{{route('subadmin.employees.store')}}" method="POST" enctype="multipart/form-data" id="kt_account_profile_details_form" class="form" autocomplete="off">
                                @csrf
                                <!--begin::Card body-->
                                <div class="card-body border-top " >
                                    <div class="row mb-6" style="display:none;">
                                        ...
                                        <div class="col-lg-8 fv-row">
                                            <input type="text" name="id" placeholder=" الكود" value="" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" />
                                        </div>
                                        <label class="col-sm-2 col-form-label fw-semibold fs-6">token </label>
                                        <div class="col-sm-3 fv-row">
                                            <input type="text" name="token" placeholder=" token" value="" class="form-control form-control-lg form-control-solid mb-3 mb-sm-0" />
                                        </div>
                                    </div>
                                    <div class="row mb-6">
                                        <label class="col-lg-2 col-form-label required fw-semibold fs-6 ">الكود </label>
                                        <div class="col-lg-8 fv-row">
                                            <input type="number" required name="emp_code" placeholder="الكود " value="" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" />
                                        </div>
                                    </div>
                                    <div class="row mb-6">
                                        <label class="col-lg-2 col-form-label required fw-semibold fs-6 ">2الكود </label>
                                        <div class="col-lg-8 fv-row">
                                            <input type="text" required name="del_code" placeholder=" 2الكود" value="" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" />
                                        </div>
                                    </div>
                                    <div class="row mb-6">
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <div class="col-lg-8 fv-row">
                                            <input type="text" name="name_en" placeholder="الاسم بالانجليزي " value="" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" />
                                        </div>
                                    </div>
                                    <div class="row mb-6">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-3 fv-row ">
                                            <input type="tel" name="phone" placeholder="رقم الهاتف" id="phone" value="" class="form-control form-control-lg form-control-solid" />
                                        </div>
                                        <div class="col-sm-3 fv-row">
                                            <input type="tel" name="phone1" placeholder="رقم بديل"  id="phone1" value="" class="form-control form-control-lg form-control-solid" />
                                        </div>
                                        <div class="col-sm-3 fv-row">
                                            <input type="tel" name="phone2" placeholder="رقم ارضي" id="phone2" value="" class="form-control form-control-lg form-control-solid" />
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <label class="col-lg-2 col-form-label required fw-semibold fs-6">العنوان</label>
                                        <div class="col-sm-3 fv-row">
                                            <input type="text" name="address1" placeholder="العنوان" id="address1" value="" class="form-control form-control-lg form-control-solid mb-3 mb-sm-0" />
                                        </div>
                                        <div class="col-sm-3 fv-row">
                                            <input type="text" name="address2" placeholder=" العنوان1" id="address2" value="" class="form-control form-control-lg form-control-solid mb-3 mb-sm-0" />
                                        </div>
                                        <div class="col-sm-3 fv-row">
                                            <input type="text" name="address3" placeholder=" العنوان2" id="address3" value="" class="form-control form-control-lg form-control-solid mb-3 mb-sm-0" />
                                        </div>
                                    </div>
                                    <div class="row mb-6">
                                    ...
                                    <div class="row mb-6"  >
                                        ...
                                        <div class="col-sm-3 fv-row">
                                            <input class="form-control form-control-lg form-control-solid" type="date" name="work_date" placeholder="تاريخ التعيين" value="" id="work_date"/>
                                        </div>
                                        <label class="col-sm-2 col-form-label fw-semibold fs-6">تاريخ الميلاد</label>
                                        <div class="col-sm-3 fv-row">
                                            <input class="form-control form-control-lg form-control-solid" type="date" name="birth_date" placeholder="تاريخ الميلاد" value="" id="birth_date"/>
                                        </div>
                                    </div>
                                    <div class="row mb-6">
                                        <label class="col-sm-2 col-form-label required fw-semibold fs-6">حالة الموظف</label>
                                        <div class="col-sm-3 d-flex align-items-center">
                                            <select  class="form-select form-select-lg form-select-solid " type="text" id="role_code" name="role_code" >
                                        ...
                                        <div class="col-sm-2 d-flex align-items-center">
                                            <select  class="form-select form-select-lg form-select-solid" required id="gender"  name="gender">
                                        ...
                                        <div class="col-sm-2 d-flex align-items-center" >
                                            <select  class="form-select form-select-lg form-select-solid"  id="collect_m"  name="collect_m">
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <div class="col-sm-4 d-flex align-items-center">
                                            <select  class="form-select form-select-lg form-select-solid"  id="bank_code" name="bank_code" >
                                                <option value="">اختر بنك</option>
                                                @foreach ($banks as $asd)
                                            <option value="{{ $asd->id }}">{{ $asd->name_ar }}</option>
                                            @endforeach
                                            </select>
                                            <button type="button" class="btn btn-primary btn-sm col-sm-4" data-bs-toggle="modal" data-bs-target="#kt_modal_2a">
                                                Add Bank</button>
                                        </div>
                                    ...
                                    <div class="row mb-6" id="" style="">
                                        ...
                                        <div class="col-sm-2 d-flex align-items-center">
                                            <select  class="form-select form-select-lg form-select-solid" value="" id="jobs_code" required name="jobs_code"  >
                                                <option value="">اختر</option>
                                                @foreach ($jobs as $asd)
                                            ...
                                            <button type="button" class="btn btn-primary btn-sm col-sm-1" data-bs-toggle="modal" data-bs-target="#kt_modal_1b">
                                                Add Job</button>
                                    </div>
                                    </div>
                                    <div class="row mb-6">
                                        ...
                                        <div class="col-sm-2 d-flex align-items-center">
                                            <select  class="form-select form-select-lg form-select-solid" id="type" name="type" value="" >
                                                <option value="0">Dash</option>   <!-- subadmin -->
                                                <option value="1" selected>No dash</option>
                                                <option value="2">Delivery access</option>  <!-- subadmin -->
                                                <option value="3" disabled></option> <!-- subadmin -->
                                            </select>
                                        </div>
                                        <label class="col-sm-2 col-form-label required fw-semibold fs-6" style=" max-width: 7% !important;">is_active</label>
                                        <div class="col-sm-2 d-flex align-items-center">
                                            <select  class="form-select form-select-lg form-select-solid" id="is_active"  name="is_active" value="" >
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <div class="col-sm-3 d-flex align-items-center">
                                            <select  class="form-select form-select-lg form-select-solid" value="" id="salary_code" name="salary_code" >
                                        ...
                                        <div class="col-sm-3 d-flex align-items-center"><!--0 = cash, 1 = bank_transefer -->
                                            <select  class="form-select form-select-lg form-select-solid" id="method_for_payment"  name="method_for_payment" value="" >
                    ...
                    <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{route('subadmin.employees.jobadd')}}" method="POST">
                                            @csrf
                                            <div class="row mb-12">
                                                ...
                                                <div class="col-lg-8 fv-row">
                                                    ...
                                                    <input type="hidden" id="emp_code" readonly name="emp_code" value="{{Auth::guard('subadmin')->user()->id}}" class="form-control form-control-lg form-control-solid" required style="text-align: center" />
                                                </div>
                                            </div>
                                            <div class="row mb-12">
                ...
                <div class="modal fade" tabindex="-1" id="kt_modal_2a">
                    <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{route('subadmin.employees.bankadd')}}" method="POST">
                                            @csrf
                                            <div class="row mb-12">
