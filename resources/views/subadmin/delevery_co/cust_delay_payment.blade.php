                        ...
                        <div class="modal-dialog modal-dialog-centered mw-650px">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                    <!--begin::Form-->
                                    <form action="{{route('subadmin.delevery_cos.supply_cust_del_delay_payment')}}" method="POST">
                                        @csrf
...
<script>
        $(document).ready(function() {
            ...
            $('.delivery_customer_name_order').on('change', function() {
                ...
                window.location = '{{route("subadmin.delevery_cos.submit_cust_del_delay_payment")}}'+ '/'+cust_del_code;
