            ...
            <div class="card no-border">
                ...
                <ul class="fw-bold fs-7 my-1">
                    <li class="text-muted px-2">
                        <a  href="{{ route('subadmin.delevery_cos.index') }}" class="text-danger text-hover-primary fw-bold fs-2 ">- عودة طلبات التوصيل</a>
                    </li>
                </ul>
        ...
        $('.delivery_name_order').select2({
            ...
            $('#delivery_name_order, #kt_datepicker_1, #kt_datepicker_2').on('change', function() {
                ...
                ajax: {
                    ...
                    url: "{{url('/')}}"+"/subadmin/delevery_cos/del_report_index?del_code="+del_code+"&from_date="+kt_datepicker_1+"&to_date="+kt_datepicker_2,
                    data: function (d) {
            ...
            // window.location = '{{route("subadmin.delevery_cos.del_report_index")}}'+ '/'+del_code;
            table.draw();
            })
        })
</script>
        ...
        $(function () {
            ...
            var table = $('#del_report_order_done12').DataTable({
                ...
                dom: 'Bfrtip',
                    ...
                    ajax: {
                        url: "{{url('/')}}"+"/subadmin/delevery_cos/del_report_order_done?del_code="+del_code+"&from_date="+kt_datepicker_1+"&to_date="+kt_datepicker_2,
                        data: function (d) {
                            d.del_code = $('#delivery_name_order').val(),
        ...
        $(function () {
            ...
            var table = $('#del_report_stable_done').DataTable({
                ...
                dom: 'Bfrtip',
                    ...
                    ajax: {
                        url: "{{url('/')}}"+"/subadmin/delevery_cos/del_report_stable_done?del_code="+del_code+"&from_date="+kt_datepicker_1+"&to_date="+kt_datepicker_2,
                        data: function (d) {
                            d.del_code = $('#delivery_name_order').val(),
                            d.delivery_customer_id = $('#delivery_customer_id').val(),
                            d.time_value = $('#time_value').val(),
