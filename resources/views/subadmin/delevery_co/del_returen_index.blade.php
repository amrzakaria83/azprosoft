                ...
                <div class="col-sm-5 p-3">
                        <div class="col-sm-11 p-3">
                            ...
                            <div class="col-sm-11 p-3">
                                ...
                                @if ($del_total_valu > 0)
                                <a href="{{route('subadmin.delevery_cos.submit_totalorder_del', $del_code)}}" class="btn btn-success">Success</a>
                                @endif
                </div>
                @else
                No data
...
<script>
    ...
    window.location = '{{route("subadmin.delevery_cos.delivery_order_requests_stable_payment")}}'+ '/'+del_code;
