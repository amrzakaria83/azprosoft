    ...
    <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_header_nav'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
            <li class="breadcrumb-item text-muted px-2">
                <a  href="{{ route('subadmin.delevery_cos.index') }}" class="text-muted text-hover-primary">طلبات التوصيل</a>
            </li>
        </ul>
    </div>
    <!--end::Page title-->
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end dbuttons">
                            <a href="{{route('subadmin.delivery_customers.create')}}" class="btn btn-sm btn-icon btn-primary btn-active-dark me-3 p-3">
...
<script>
    $(function () {
        ...
        var table = $('#kt_datatable_table').DataTable({
            ...
            ajax: {
                url: "{{ route('subadmin.delevery_cos.indexcustomer_order_request') }}",
                data: function (d) {
    ...
    confirmButtonText: 'موافق',cancelButtonText: 'لا'}).then(function (isConfirm) {if (isConfirm.value)
        {$.ajax({url: "{{route('subadmin.drug_requests.delete')}}",
