...
<script>
        ...
        $(function () {
            ...
            var table = $('#delivery_order_done_report').DataTable({
                ...
                ajax: {
                    url: "{{ route('subadmin.delevery_cos.delivery_order_done_report') }}",
                    data: function (d) {
...
<script>
    ...
    $(function () {
        ...
        var table = $('#delivery_stable_done_report').DataTable({
            ...
            ajax: {
                url: "{{ route('subadmin.delevery_cos.delivery_stable_done_report') }}",
                data: function (d) {
                    d.kt_datepicker_1 = $('#kt_datepicker_1').val(),
                    d.kt_datepicker_2 = $('#kt_datepicker_2').val()
...
<script>
    ...
    $(function () {
        ...
        var table = $('#delivery_income_value_report').DataTable({
            ...
            ajax: {
                url: "{{ route('subadmin.delevery_cos.delivery_income_value_report') }}",
                data: function (d) {
                    d.kt_datepicker_1 = $('#kt_datepicker_1').val(),
                    d.kt_datepicker_2 = $('#kt_datepicker_2').val()
