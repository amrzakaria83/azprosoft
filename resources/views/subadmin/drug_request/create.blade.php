    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
                <form action="{{route('subadmin.drug_requests.store')}}" method="POST" enctype="multipart/form-data" id="kt_account_profile_details_form" class="form">
                    @csrf
                    <!--begin::Card body-->
                ...
                <!--end::Form-->
                <div>
                    <a href="{{route('subadmin.drug_requests.import')}}" >
                        تحميل ملف اكسيل
                    </a>
                </div>
...
<script>
    $('#product_code').keyup(function (e) {
        if ((e.keyCode || e.which) == 39) {
            ...
            $.ajax({
                type: "GET",
                url: "{{ url('subadmin/drug_requests/getprod')}}",
    ...
    $('.itemName').select2({
        ...
        ajax: {
            type: "GET",
            url: '{{ url('subadmin/drug_requests/ProdName')}}',
            dataType: 'json',
            delay: 250,
...
<script>
    $(function () {
        ...
        var table = $('#kt_datatable_table').DataTable({
            ...
            ajax: {
                url: "{{ route('subadmin.drug_requests.spe') }}",
                data: function (d) {
