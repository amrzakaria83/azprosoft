    ...
    <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_header_nav'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
            <li class="breadcrumb-item text-muted px-2">
                <a  href="{{route('subadmin.drug_requests.create')}}" class="text-muted text-hover-primary">'اضف طلب ادوية من صيدلية'</a>
            </li>
        </ul>
    </div>
    <!--end::Page title-->
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end dbuttons">
                            <a href="{{route('subadmin.drug_requests.create')}}" class="btn btn-sm btn-icon btn-primary btn-active-dark me-3 p-3">
                                ...
                                <!--begin::Form-->
                                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                        <div class="fv-row mb-7">
                                            ...
                                            <label for="fromit">اسم الصيدلية المراد التحويل اليها</label>
...
<script>
    $(function () {
        ...
        var table = $('#kt_datatable_table').DataTable({
            ...
            ajax: {
                url: "{{ route('subadmin.drug_requests.index') }}",
                data: function (d) {
        ...
        var table2 = $('#kt_datatable_table2').DataTable({
            processing: false,
            serverSide: true,
            searching: false,
            autoWidth: true,
            ...
            ajax: {
                url: "{{ route('subadmin.drug_requests.datatable2') }}",
                data: function (dd) {
                    dd.toit = $('#toit').find(":selected").val()
                    // d.fromit = $('#fromit').find(":selected").val()
                    }},
            columns: [
