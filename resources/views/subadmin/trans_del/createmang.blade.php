                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{route('subadmin.trans_dels.editno_receit')}}" method="POST" enctype="multipart/form-data" id="kt_account_profile_details_form" class="form">
                                    @csrf
...
<script>
    $(function () {
        ...
        var table = $('#kt_datatable_table1').DataTable({
            ...
            ajax: {
                url: "{{ route('subadmin.trans_dels.indexmang') }}",
                data: function (d) {
                    d.is_active = $('#is_active').val(),
                    d.search = $('#search').val()
                }
...
<script>
    $(function () {
        ...
        var table = $('#kt_datatable_table2').DataTable({
            ...
            ajax: {
                url: "{{ route('subadmin.trans_dels.indexreq') }}",
                data: function (d) {
                    d.is_active = $('#is_active').val(),
                    d.search = $('#search').val()
                }
...
<script>
    function edit_status(id) {
        Swal.fire({
            ...
            $.ajax({
                url: "{{ url('/subadmin/trans_dels/edit_status') }}/" + id + "/" + status_edit,
                method: "GET",
...
<script>
    function edit_to_id(id) {
        Swal.fire({
            ...
            $.ajax({
                url: "{{ url('/subadmin/trans_dels/edit_to_id') }}/" + id + "/" + edit_to_id,
                method: "GET",
...
<script>
    function edit_del(id) {
        Swal.fire({
            ...
            $.ajax({
                url: "{{ url('/subadmin/trans_dels/edit_del') }}/" + id + "/" + edit_del,
                method: "GET",
