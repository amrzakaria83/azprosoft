...
@section('content')
    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card no-border">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end dbuttons">
                            <a href="{{route('subadmin.trans_dels.create')}}" class="btn btn-sm btn-icon btn-primary btn-active-dark me-3 p-3">
                ...
                <div class="row mb-6">
                            <label class="col-lg-2 col-form-label fw-semibold fs-6">من</label>
                            <div class="col-lg-4 fv-row">
                                <input type="datetime-local" class="form-control mb-3 mb-lg-0" id="kt_datepicker_1" name="from_time" >
                            </div>
                        {{-- </div>
                        <div class="row mb-6"> --}}
                            <label class="col-lg-2 col-form-label fw-semibold fs-6">الى</label>
                            <div class="col-lg-4 fv-row">
                                <input type="datetime-local" class="form-control mb-3 mb-lg-0" id="kt_datepicker_2" name="to_time" >
                            </div>
                        </div>
                    <!--begin::Table-->
                    <table class="table align-middle table-rounded table-striped table-row-dashed fs-6" id="kt_datatable_table">
                        ...
                        <thead class="bg-light-dark pe-3">
                            ...
                            <tr class="text-start text-dark fw-bold fs-4 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px text-start">الطيار</th>
                                <th class="min-w-125px text-start">التحوبلات</th>
                                <th class="min-w-125px text-start">الاوردرات</th>
...
<script>
    $(function () {
        ...
        var table = $('#kt_datatable_table').DataTable({
            ...
            ajax: {
                url: "{{ route('subadmin.trans_dels.indexalldelrep') }}",
                data: function (d) {
