@extends('subadmin.layout.master-nosidbar-no header')
    ...
    <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_header_nav'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
            <li class="breadcrumb-item text-muted px-2">
                <a  href="{{route('subadmin.sites.index')}}" class="text-muted text-hover-primary">الشركات</a>
            </li>
    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
                <form action="{{route('subadmin.sites.store')}}" method="POST" enctype="multipart/form-data" id="kt_account_profile_details_form" class="form">
                    @csrf
                    <!--begin::Card body-->
                    <div class="card-body  p-9">

                        <div class="row mb-6">
                            <label class="col-lg-2 col-form-label fw-semibold fs-6">شعار الشركة</label>
                            <div class="col-lg-8">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="number" name="commercial" placeholder="رقم السجل التجاري" value="" class="form-control form-control-lg form-control-solid" />
                            </div>
                        </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="date" name="start_date" placeholder="تاريخ البدء" value="" class="form-control form-control-lg form-control-solid" />
                            </div>
                        </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="date" name="end_date" placeholder="تاريخ الانتهاء" value="" class="form-control form-control-lg form-control-solid" />
                            </div>
                        </div>
...
// $table->enum('type', ['0', '1', '2', '3'])->default('0')->comment(' صيدلية=0- مخزن =1 - نقطة تحرك = 2 - موقع معرف = 3 ');
// $table->string('phone1',191)->nullable();
// $table->bigInteger('phone2')->nullable();
// $table->bigInteger('phone3')->nullable();
