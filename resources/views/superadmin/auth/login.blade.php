					...
					<div class="bg-body d-flex flex-column flex-center rounded-4 w-md-600px p-10">
						...
						<div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
							...
							<div class="d-flex flex-center flex-column-fluid pb-15 pb-lg-20">
								<!--begin::Form-->
                                <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" method="POST" action="{{route('superadmin.login.submit')}}">
                                    @csrf
                                    <!--begin::Heading-->
                                    ...
                                    <div class="row mb-8">
                                            <div class="col-md-6">
                                                <select class="form-select" autofocus aria-label="Select example" id="insite" name="insite" required style="background-color: rgb(250, 250, 121);">
                                                    <option value="" >برجاء اختيار مكان الدخول</option>
                                            ...
                                            <div class="col-md-4">
                                                    <select class="form-select" autofocus aria-label="Select example" id="cashier" name="cashier" required style="background-color: rgb(254, 153, 153);">
                                                        {{-- <option value="" >برجاء اختيار الخزينة</option> --}}
                                    ...
                                    <div class="fv-row mb-8">
                                        <input type="number" placeholder="please insert your code" id="emp_code" name="emp_code" value="{{ old('emp_code') }}" required autocomplete="off" autofocus class="form-control bg-transparent @error('emp_code') is-invalid @enderror" />
                                        <!--end::Email-->
                                        @error('emp_code')
                                    ...
                                    <div class="fv-row mb-3">
                                        <!--begin::Password-->
                                        <input type="password" placeholder="please insert your password" id="password" name="password" required autocomplete="new-password" class="form-control bg-transparent @error('password') is-invalid @enderror" />
