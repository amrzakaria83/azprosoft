                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end dbuttons">
                            <a href="{{route('superadmin.azcustomers.create')}}" class="btn btn-sm btn-icon btn-primary btn-active-dark me-3 p-3">
                    ...
                    <table class="table align-middle table-rounded table-striped table-row-dashed fs-6" id="kt_datatable_table">
                        ...
                        <thead class="bg-light-dark pe-3">
                            ...
                            <tr class="text-start text-dark fw-bold fs-4 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px text-start">رقم الهاتف 1</th>
                                <th class="min-w-125px text-start">رقم الهاتف 2</th>
                                <th class="min-w-125px text-start">العنوان المسجل</th>
                            </tr>
                            <!--end::Table row-->
                        </thead>
                        <!--end::Table head-->
...
<script>
    $(function () {
        ...
        var table = $('#kt_datatable_table').DataTable({
            ...
            ajax: {
                url: "{{ route('superadmin.azcustomers.index') }}",
                data: function (d) {
                    d.cust_name_ar = $('#cust_name_ar').val(),
                    d.phone1 = $('#phone1').val(),
                    d.phone2 = $('#phone2').val(),
                    d.search = $('#search').val()
                }
            ...
            columns: [
                ...
                {data: 'cust_name_ar', cust_name_ar: 'name'},
            ...
            if (checkIDs.length > 0) {
                ...
                Swal.fire({
                    ...
                    if (isConfirm.value) {
                        $.ajax(
                        {
                            url: "{{route('superadmin.drug_requests.delete')}}",
                            type: 'post',
                            dataType: "JSON",
                            data: {
                                "id": checkIDs,
