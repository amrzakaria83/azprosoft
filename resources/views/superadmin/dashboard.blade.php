            ...
            <div id="kt_apexcharts_1" ></div>
                            {{-- <div class="container text-center " id="">
                                    <div class="row align-items-start">
                                        <h1>طلب دليفرى</h1>
                                        <div class="col-sm-3  ">
                                            <a href="http://127.0.0.1:8000/superadmin/tranph_requests/create" target="_blank" >
                                            <button type="button" class="btn btn-danger btn-lg container" onclick="">طلب تحويل صيدلية</button>
                                            </a>
                                        </div>
                                        <div class="col-sm-3  ">
                                            <a href="http://127.0.0.1:8000/superadmin/orderphs/create" target="_blank" >
                                ...
                                <div class="row align-items-start" >
                                    <h1>حركة دليفرى</h1>
                                    <div class="col-sm-3  ">
                                        <a href="http://127.0.0.1:8000/superadmin/tranph_requests" target="_blank" >
                                ...
                                <div class="row align-items-start" >
                                    ...
                                    <div class="col-sm-2  ">
                                        <a href="http://127.0.0.1:8000/superadmin/sites/create" target="_blank" >
