...
@section('content')
    ...
    {{-- <a href="{{route('superadmin.delevery_cos.submit_cust_del_delay_payment')}}" class="btn btn-success container">ترحيل الى الحساب</a> --}}
...
<script>
    function customer_check_stable(id, status_payment, value_return_total) {
        ...
        Swal.fire({
            ...
            $.ajax({
                url: "{{ url('/superadmin/delevery_cos/edit_value_return_stable_total_delay') }}/" + id + "/" + value_return_total,
                method: "GET",
