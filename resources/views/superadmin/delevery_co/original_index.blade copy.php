...
<script>
        ...
        $(function () {
            ...
            $('#submitForm_add_order_req').click(function(){
                ...
                $.ajax({url: "{{url('/')}}"+"/superadmin/delevery_cos/store?id="+id+"&del_code="+is_del_code, success: function(result){
                    console.log(result);
                    if (del_code) {
                        table.draw();
                    } else {
    ...
    $(function () {
        ...
        $('#asdasd').click(function(){
            ...
            if (del_code) {
                ...
                $.ajax({url: "{{url('/')}}"+"/superadmin/delevery_cos/storestable?id="+id+"&time_go="+theTime+"&del_code="+is_del_code, success: function(result){
                if (del_code) {
                    location.reload()
                } else {
                    location.reload()
