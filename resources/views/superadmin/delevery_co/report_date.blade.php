                ...
                <div class="row align-items-start">
                            ...
                            <h3 style="width: 20%">طلب توصيل
                                ...
                                <div class="card-body py-4">
                                    <!--begin::Table-->
                                            ...
                                            <table class="table align-middle table-rounded table-striped table-row-dashed fs-6" id="delivery_order_done_report">
                                                <!--begin::Table head-->
                    ...
                    <div class="col-sm-4 p-3">
                        <div class="row">
                            ...
                            <div class="card-body py-4">
                                            ...
                                            <table class="table align-middle table-rounded table-striped table-row-dashed fs-6" id="delivery_stable_done_report">
                                                <!--begin::Table head-->
                                                <thead class="bg-light-dark pe-3">
                                                    <!--begin::Table row-->
                                                    <tr class="text-start text-dark fw-bold fs-2 text-uppercase gs-0">
                    ...
                    <div class="col-sm-4 p-3">
                        <h3>التوريد</h3>
                            ...
                            <div class="card-body py-4">
                                            <!--begin::Table-->
                                            <table class="table align-middle table-rounded table-striped table-row-dashed fs-6" id="delivery_income_value_report">
                                                <!--begin::Table head-->
                                                <thead class="bg-light-dark pe-3">
                                                    <!--begin::Table row-->
                                                    <tr class="text-start text-dark fw-bold fs-2 text-uppercase gs-0">
...
<script>
        ...
        $(function () {
            ...
            var table = $('#delivery_order_done_report').DataTable({
                processing: false,
                serverSide: true,
                searching: false,
                autoWidth: false,
                ...
                ajax: {
                    url: "{{ route('superadmin.delevery_cos.delivery_order_done_report') }}",
                    data: function (d) {
                        d.kt_datepicker_1 = $('#kt_datepicker_1').val(),
                        d.kt_datepicker_2 = $('#kt_datepicker_2').val()
                    }
                },
                columns: [
...
<script>
    ...
    $(function () {
        ...
        var table = $('#delivery_stable_done_report').DataTable({
            processing: false,
            serverSide: true,
            searching: false,
            autoWidth: false,
            ...
            ajax: {
                url: "{{ route('superadmin.delevery_cos.delivery_stable_done_report') }}",
                data: function (d) {
                    d.kt_datepicker_1 = $('#kt_datepicker_1').val(),
                    d.kt_datepicker_2 = $('#kt_datepicker_2').val()
...
<script>
    ...
    $(function () {
        ...
        var table = $('#delivery_income_value_report').DataTable({
            processing: false,
            serverSide: true,
            searching: false,
            autoWidth: false,
            ...
            ajax: {
                url: "{{ route('superadmin.delevery_cos.delivery_income_value_report') }}",
                data: function (d) {
                    d.kt_datepicker_1 = $('#kt_datepicker_1').val(),
                    d.kt_datepicker_2 = $('#kt_datepicker_2').val()
