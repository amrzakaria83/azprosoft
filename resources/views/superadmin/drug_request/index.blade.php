    ...
    <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_header_nav'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
            <li class="breadcrumb-item text-muted px-2">
                <a  href="{{route('superadmin.drug_requests.create')}}" class="text-muted text-hover-primary">'اضف طلب ادوية من صيدلية'</a>
            </li>
        </ul>
    </div>
    <!--end::Page title-->
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end dbuttons">
                            <a href="{{route('superadmin.drug_requests.create')}}" class="btn btn-sm btn-icon btn-primary btn-active-dark me-3 p-3">
...
<script>
    $(function () {
        ...
        var table2 = $('#kt_datatable_table2').DataTable({
            ...
            ajax: {
                url: "{{ route('superadmin.drug_requests.datatable2') }}",
                data: function (dd) {
