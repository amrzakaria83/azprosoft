    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card no-border">
                ...
                <div class="card-body py-4">
                    ...
                    <!--begin::Table-->
                    <form action="{{route('superadmin.inventory_requests.updateqty')}}" method="POST">
                        @csrf
                        ...
                        <table class="table align-middle table-rounded table-striped table-row-dashed fs-6  " id="kt_datatable_table">
                            ...
                            <thead class="bg-light-dark pe-1">
                                ...
                                <tr class="text-start text-dark fw-bold fs-4 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-10px text-start">الكمية الفعلبة</th>
                                ...
                                <!--begin::Form-->
                                    ...
                                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                        ...
                                        <div class="fv-row mb-7">
                                            <label for="toit">اسم الصيدلية المراد جردها </label>
    ...
    $(function () {
        ...
        var table = $('#kt_datatable_table').DataTable({
            ...
            buttons: [
                ...
                //     text: 'طباعه'
                // },
                // {extend: 'pdf', className: 'btn btn-sm btn-icon btn-danger', text: 'PDF'},
                // {
                //     extend: 'excel',
            ...
            ajax: {
                url: "{{ route('superadmin.inventory_requests.index') }}",
                data: function (d) {
...
<script>
    $("#toit").val()
    var product_name_en = $('#toit').find(":selected").text()
    $("#product_name_en").html("المخزن :" + product_name_en)
</script>
<script>
$(document).ready(function() {
  // Add change event handler to the "toit" select element
  $("#toit").change(function() {
    // Get the selected option's text
    var product_name_en = $(this).find(":selected").text();
    // Update the content of the "product_name_en" element
    $("#product_name_en").html( "المخزن :" + product_name_en);
});});
</script>
@endsection
