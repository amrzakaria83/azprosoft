    ...
    <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_header_nav'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
            <li class="breadcrumb-item text-muted px-2">
                <a  href="{{route('superadmin.messages.index')}}" class="text-muted text-hover-primary">الرسائل</a>
            </li>
...
@section('content')
    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        <a href="{{route('superadmin.messages.inbox')}}" class="btn btn-outline btn-outline-dashed btn-outline-primary btn-active-light-primary">البريد الوارد</a>
        <a href="{{route('superadmin.messages.index')}}" class="btn btn-outline btn-dashed btn-primary btn-active-light-primary">البريد الصادر</a>
        <a href="{{route('superadmin.messages.reportcc')}}" class="btn btn-outline btn-dashed btn-primary btn-active-light-primary">المتابعة</a>
                    ...
                    <table class="table align-middle table-rounded table-striped table-row-dashed fs-6" id="kt_datatable_table">
                        ...
                        <thead class="bg-light-dark pe-3">
                            ...
                            <tr class="text-start text-dark fw-bold fs-4 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px text-start">وارد من</th>
                                <th class="min-w-125px text-start">الوقت والتاريخ</th>
                            ...
                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                ...
                                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <select id="status" data-control="select2" data-placeholder="اختـر ..." data-hide-search="true" class="form-select form-select-solid fw-bold" name="status" >
                                            <option >اختر ...</option>
