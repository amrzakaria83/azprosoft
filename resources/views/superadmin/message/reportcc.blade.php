...
@section('content')
    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        <a href="{{route('superadmin.messages.inbox')}}" class="btn btn-outline btn-dashed btn-primary btn-active-light-primary">البريد الوارد</a>
        ...
        <a href="{{route('superadmin.messages.reportcc')}}" class="btn btn-outline btn-dashed btn-dashed btn-active-light-primary">المتابعة</a>
                    ...
                    <table class="table align-middle table-rounded table-striped table-row-dashed fs-6" id="kt_datatable_table">
                        ...
                        <thead class="bg-light-dark pe-3">
                            ...
                            <tr class="text-start text-dark fw-bold fs-4 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px text-start">اسم المرسل</th>
