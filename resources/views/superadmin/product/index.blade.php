                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end dbuttons">
                            {{-- <a href="{{route('superadmin.products.create')}}" class="btn btn-sm btn-icon btn-primary btn-active-dark me-3 p-3">
                    ...
                    <table class="table align-middle table-rounded table-striped table-row-dashed fs-6" id="kt_datatable_table">
                        ...
                        <thead class="bg-light-dark pe-3">
                            ...
                            <tr class="text-start text-dark fw-bold fs-4 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px text-start">اسم الصنف</th>
                                <th class="min-w-125px text-start">السعر</th>
                                <th class="min-w-125px text-start">طبيعة الصنف</th>
    ...
    $(function () {
        ...
        var table = $('#kt_datatable_table').DataTable({
            ...
            ajax: {
                ...
                data: function (d) {
                    d.product_name_en = $('#product_name_en').val(),
                    d.search = $('#search').val()
                }
            },
            columns: [
                ...
                {data: 'drug_undrug', name: 'drug_undrug'},
