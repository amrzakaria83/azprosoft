    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
                <form action="{{route('superadmin.pur_drug_requests.store')}}" method="POST" enctype="multipart/form-data" id="kt_account_profile_details_form" class="form">
                    @csrf
                    ...
                    <div class="card-body  p-9">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-sm-1">
                                ...
                                <input type="number" id="quantity" name="quantity" value="1" class="form-control form-control-lg form-control-solid" required style="text-align: center;background-color: #ffe564;" required />
                            </div>
                            <div class="col-sm-3">
                ...
                <!--end::Form-->
                <div>
                    <a href="{{route('superadmin.pur_drug_requests.create_non_code')}}" >
                        صنف جديد
                    </a>
                </div>
                <table class="table align-middle table-rounded table-striped table-row-dashed fs-6  " id="kt_datatable_table">
                    ...
                    <thead class="bg-light-dark pe-1">
                        ...
                        <tr class="text-start text-dark fw-bold fs-4 text-uppercase gs-0">
                            ...
                            <th class="min-w-50px text-start">وقت الوصول</th>
...
var table = $('#kt_datatable_table').DataTable({
    ...
    ajax: {
        url: "{{ route('superadmin.pur_drug_requests.indexstore') }}",
        data: function (d) {
