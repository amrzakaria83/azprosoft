    ...
    <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_header_nav'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
            <li class="breadcrumb-item text-muted px-2">
                <a  href="http://127.0.0.1:8000/superadmin/drug_requests/create" class="text-muted text-hover-primary">'طلب  شراء ادوية '</a>
            </li>
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end dbuttons">
                            <a href="{{route('superadmin.pur_drug_requests.create')}}" class="btn btn-sm btn-icon btn-primary btn-active-dark me-3 p-3">
                ...
                <div class="row align-items-start">
                    <div class="col-sm-12 p-3">
                        <div class="card-body py-4">
                            <h3 style="width: 40%">اصناف مكودة </h3>
                            <!--begin::Table-->
                            <table class="table align-middle table-rounded table-striped table-row-dashed fs-6  " id="kt_datatable_table">
                                ...
                                <thead class="bg-light-dark pe-1">
                                    ...
                                    <tr class="text-start text-dark fw-bold fs-4 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-20px text-start">بيانات العميل</th>
                    ...
                    <div class="col-sm-12 p-3">
                        <div class="card-body py-4">
                            <h3 class="text-danger" style="width: 70%">اصناف غير مكودة </h3>
                            <!--begin::Table-->
                            <table class="table align-middle table-rounded table-striped table-row-dashed fs-6  " id="kt_datatable_table_non_coded">
                                <!--begin::Table head-->
                                <thead class="bg-light-dark pe-1">
                                    <!--begin::Table row-->
                                    <tr class="text-start text-dark fw-bold fs-4 text-uppercase gs-0">
                                        <th class="w-10px p-3">
                                            <div class="form-check form-check-sm form-check-custom form-check-solid ">
                                                <input class="form-check-input" type="checkbox" data-kt-check="true" data-kt-check-target="#kt_datatable_table_non_coded .form-check-input" value="1" />
                                            </div>
                                        </th>
                                        <th class="min-w-50px text-start">اسم الصنف</th>
                                        <th class="min-w-10px text-start">الكمية</th>
                                    ...
                                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <select class="form-select" autofocus required aria-label="Select example" id="fromit" name="start_id" >
                                                <option disabled selected>جميع الصبدليات</option>
...
<script>
    $(function () {
        ...
        var table = $('#kt_datatable_table').DataTable({
            ...
            ajax: {
                url: "{{ route('superadmin.pur_drug_requests.index') }}",
                data: function (d) {
                    d.getprod = $('#getprod').text(),
                    d.search = $('#search').val()
                },
            },
            columns: [
...
<script>
    $(function () {
        ...
        var table = $('#kt_datatable_table_non_coded').DataTable({
            processing: false,
            serverSide: true,
            searching: false,
            autoWidth: true,
            ...
            ajax: {
                url: "{{ route('superadmin.pur_drug_requests.indexe_non_code') }}",
                data: function (d) {
                    d.product_name_en = $('#product_name_en').text(),
                    d.search = $('#search').val()
                },
            },
            columns: [
