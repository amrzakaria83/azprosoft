    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
                <!--begin::Form-->
                <form action="{{route('superadmin.settings.update')}}" method="POST" enctype="multipart/form-data" id="kt_account_profile_details_form" class="form">
                    @csrf
                    <!--begin::Card body-->
                    <div class="card-body border-top p-9">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="setting" role="tabpanel">
                                <!--begin::Form-->
                                <form action="{{route('superadmin.settings.update')}}" method="POST" class="form" >
                                    @csrf
                            ...
                            <div class="tab-pane fade" id="media" role="tabpanel">
                                <!--begin::Form-->
                                <form action="{{route('superadmin.settings.update')}}" method="POST" class="form" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row fv-row mb-7">
                                        <div class="col-md-3 text-md-end">
                                            <label class="fs-6 fw-semibold form-label mt-3">
