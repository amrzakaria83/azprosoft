            ...
            <div class="card no-border">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="">
                        ...
                        Add company shipping
                    </button>
                                <div class="modal fade" tabindex="-1" id="kt_modal_1">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h3 class="modal-title"> Add company shipping اضافة شركة شحن</h3>
                                                <!--begin::Close-->
                                            ...
                                            <div class="modal-body">
                                                <form action="{{route('superadmin.shippings.storecompanyshipping')}}" method="POST">
                                                    @csrf
                                                    <div class="row mb-12">
                                                        <label class="col-lg-3 col-form-label required fw-semibold fs-6">اسم الشركة بالعربية</label>
                                                    ...
                                                    <div class="row mb-12">
                                                        <label class="col-lg-3 col-form-label required fw-semibold fs-6">اسم الشركة بالانجليزية</label>
                                                        <div class="col-lg-8 fv-row">
                                                    ...
                                                    <div class="row mb-12">
                                                        <label class="col-lg-3 col-form-label required fw-semibold fs-6">تليفون </label>
                                                        <div class="col-lg-8 fv-row">
                                                            <input type="tel" id="phone1" name="phone1" required placeholder="تليفون" value="" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" />
                                                        </div>
                                                    </div>
                                                    <div class="row mb-12">
                                                        <label class="col-lg-3 col-form-label  fw-semibold fs-6">تليفون 1 </label>
                                                        <div class="col-lg-8 fv-row">
                                                            <input type="tel" id="phone2" name="phone2"  placeholder="1 تليفون" value="" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" />
                                                        </div>
                                                    </div>
                                                    <div class="row mb-12">
                                                        <label class="col-lg-3 col-form-label required fw-semibold fs-6">العنوان</label>
                                                        <div class="col-lg-8 fv-row">
                                                            <input type="text" id="address" name="address" required placeholder="العنوان" value="" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" />
                                                        </div>
                                                    </div>
                                                    <div class="row mb-12">
                                                        <label class="col-lg-3 col-form-label required fw-semibold fs-6">ملاحظات</label>
                                                        <div class="col-lg-8 fv-row">
                                                            <input type="text" id="note" name="note" required placeholder="ملاحظات" value="" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" />
                                                        </div>
                                                    </div>
                                            </div>
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end dbuttons">
                            <a href="{{route('superadmin.shippings.create')}}" class="btn btn-sm btn-icon btn-primary btn-active-dark me-3 p-3">
                ...
                <!--end::Card header-->
                <form action="{{route('superadmin.shippings.doneshipping')}}" method="POST">
                    @csrf
                <!--begin::Card body-->
                    ...
                    <table class="table align-middle table-rounded table-striped table-row-dashed fs-6" id="kt_datatable_table">
                        ...
                        <thead class="bg-light-dark pe-3">
                            ...
                            <tr class="text-start text-dark fw-bold fs-4 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px text-start">بيانات الطلب</th>
                                <th class="min-w-125px text-start">شركة الشحن</th>
                                <th class="min-w-125px text-start">قيمة الشحن</th>
                                <th class="min-w-125px text-start">رقم الريسيت</th>
                                <th class="min-w-125px text-start">الرد</th>
                            </tr>
                            <!--end::Table row-->
                        </thead>
                        <!--end::Table head-->
...
<script>
    $(function () {
        ...
        var table = $('#kt_datatable_table').DataTable({
            ...
            ajax: {
                url: "{{ route('superadmin.shippings.shippingnone') }}",
                data: function (d) {
            ...
            columns: [
                ...
                {data: 'name', name: 'name'},
                {data: 'shipping_co', name: 'shipping_co'},
                {data: 'value_shipping', name: 'value_shipping'},
