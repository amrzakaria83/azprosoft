    ...
    <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_header_nav'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
            <li class="breadcrumb-item text-muted px-2">
                <a  href="{{route('superadmin.users.index')}}" class="text-muted text-hover-primary">الشركات</a>
            </li>
    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
                <!--begin::Form-->
                <form action="{{route('superadmin.users.update')}}" method="POST" enctype="multipart/form-data" id="kt_account_profile_details_form" class="form">
                    @csrf
                    ...
                    <div class="card-body border-top p-9">
                        ...
                        <div class="row mb-6">
                            <label class="col-lg-2 col-form-label required fw-semibold fs-6">اسم الشركة</label>
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="company_name" placeholder="اسم الشركة" value="{{$data->company_name}}" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" />
                            </div>
                        </div>

                        <div class="row mb-6">
                            <label class="col-lg-2 col-form-label required fw-semibold fs-6">اسم المسؤول</label>
                            <div class="col-lg-8 fv-row">
                        ...
                        <div class="row mb-6">
                            <label class="col-lg-2 col-form-label fw-semibold fs-6">
                                <span class="">رقم السجل التجاري</span>
                            </label>
                            <div class="col-lg-8 fv-row">
                                <input type="number" name="commercial" placeholder="رقم السجل التجاري" value="{{$data->commercial}}" class="form-control form-control-lg form-control-solid" />
                            </div>
                        </div>

                        <div class="row mb-6">
                            <label class="col-lg-2 col-form-label fw-semibold fs-6">
                                <span class="">تاريخ البدء</span>
                            </label>
                            <div class="col-lg-8 fv-row">
                                <input type="date" name="start_date" placeholder="تاريخ البدء" value="{{$data->start_date}}" class="form-control form-control-lg form-control-solid" />
                            </div>
                        </div>

                        <div class="row mb-6">
                            <label class="col-lg-2 col-form-label fw-semibold fs-6">
                                <span class="">تاريخ الانتهاء</span>
                            </label>
                            <div class="col-lg-8 fv-row">
                                <input type="date" name="end_date" placeholder="تاريخ الانتهاء" value="{{$data->end_date}}" class="form-control form-control-lg form-control-solid" />
                            </div>
                        </div>
